...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) 
	{
		...
		db.execSQL("CREATE TABLE STUDENT ( _id INTEGER primary key autoincrement not null , " +
                   						   "ID_NO TEXT, " +
                   						   "FIRST_NAME TEXT, " +
                   						   "LAST_NAME TEXT, " +
                   						   "CLASS TEXT, " +
		...
		db.execSQL("CREATE TABLE ATTENDANCE( _id INTEGER primary key autoincrement not null, " +
                							 "ID_NO TEXT, " +
                							 "SUBJECT TEXT, " +
                							 "DATE DATE, " +
                							 "P_A CHECKBOX, " +
		...
		db.execSQL("CREATE TABLE CLASS( _id INTEGER primary key autoincrement not null, " +
                   						"NAME TEXT, " +
                   						"DEPARTMENT TEXT, " +
		...
		db.execSQL("CREATE TABLE SUBJECT( _id INTEGER primary key autoincrement not null, " +
                						 "CODE TEXT, " +
                						 "NAME TEXT, " +
                						 "DEPARTMENT TEXT, " +
                						 "DESCRIPTION TEXT, " +
		...
		db.execSQL("CREATE TABLE DEPARTMENT( _id INTEGER primary key autoincrement not null, " +
                							"NAME TEXT, " +
                							"DESCRIPTION TEXT, " +
                							"PRIMARY KEY(_id, NAME));");
